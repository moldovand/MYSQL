...
int main(int argc, char **argv)
{
  ...
  if (mysql_real_connect(con, "localhost", "daniel", "34klq*",
          "testCREATE_DB", 0, NULL, 0) == NULL)
  {
  ...
  if (mysql_query(con, "INSERT INTO cars VALUES(8,'Toyota',31400)")) {
      finish_with_error(con);
  }

  if (mysql_query(con, "INSERT INTO cars VALUES(9,'Volkswagen',21600)")) {
      finish_with_error(con);
  }
